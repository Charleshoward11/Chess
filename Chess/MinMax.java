...
public class MinMax
{
                ...
                if(b.getSquare(i,j).hasPiece())
                {
                    ...
                    if(piece.isWhite == true)
                    {
                        for(int k = 0; k < 8; k++)
                        {
                            for(int l = 0; l<8; l++)
                            {
                                if(piece.checkLegalMove(new Point(k*62,l*62),b))
                                { //k and l and multiplied by 62 because checkLegalMove takes the pixel positions as parameters
    ...
    public String doMove(Board b, Move moveToMake){
        ...
        {
            if(pieceToMove.getColor() == false)
            {//case that it is white king
                if(b.hasPiece(7, 7))
                {
            ...
            else if(pieceToMove.getColor() == true)
            { //case that it is black king
                if(b.hasPiece(7, 0))
                {
